...
$string['choosereadme'] = 'Nebula is a modern highly-customisable theme. This theme is intended to be used directly, or as a parent theme when creating new themes utilising Bootstrap 4.
	<div>Thanks for choosing Us.</div>';

$string['currentinparentheses'] = '(current)';
$string['region-side-pre'] = 'Right';
$string['prev_section'] = 'Previous section';
$string['next_section'] = 'Next section';
$string['themedevelopedby'] = 'This theme was developed by - Erudisiya PVT. LTD.';
$string['themecopyright'] = 'Copyright © '.date("Y").' Erudisiya PVT. LTD. | All Rights Reserved.';
...
$string['logo'] = 'Logo';
$string['logodesc'] = 'The logo is displayed in the header. Preferred image Aspect Ratio 5:1';
$string['favicon'] = 'Custom favicon';
$string['favicondesc'] = 'Upload your own favicon.  It should be an .png file.';
