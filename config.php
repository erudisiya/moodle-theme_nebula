...
$THEME->scss = function($theme) {
    return theme_nebula_get_main_scss_content($theme);
};
...
$THEME->extrascsscallback = 'theme_nebula_get_extra_scss';
$THEME->prescsscallback = 'theme_nebula_get_pre_scss';
$THEME->precompiledcsscallback = 'theme_nebula_get_precompiled_css';
$THEME->yuicssmodules = [];
