...
namespace theme_nebula\output;

use theme_config;
use context_course;
use moodle_url;
use html_writer;
use theme_nebula\output\core_course\activity_navigation;
...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function body_attributes($additionalclasses = array()) { 
        $hasaccessibilitybar = get_user_preferences('themenebulasettings_enableaccessibilitytoolbar', '');
        ...
        $fonttype = get_user_preferences('themenebulasettings_fonttype', '');
        if ($fonttype) {
    ...
    public function get_theme_logo_url() {
        ...
        if ($theme->setting_file_url('logo', 'logo')) {
          return $theme->setting_file_url('logo', 'logo');
        } else {
          return $CFG->wwwroot.'/theme/nebula/pix/logo.png';
        }
    }
    ...
    public function favicon() {
        ...
        if (!empty(($favicon))) {
            ...
            $default = $CFG->wwwroot."/theme/nebula/pix/favicon.png";
            return $default;
        }
    ...
    public function get_navbar_callbacks_data() {
        $callbacks = get_plugins_with_function('nebula_additional_header', 'lib.php');
