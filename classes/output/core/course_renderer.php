...
namespace theme_nebula\output\core;

use html_writer;
use coursecat_helper;
use stdClass;
use core_course_list_element;
use theme_nebula\util\course;

/**
 * Renderers to align nebula's course elements to what is expect
 *
 * @package    theme_nebula
 * @copyright  2022 Erudisiya PVT LTD - https://erudisiya.com/
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class course_renderer extends \core_course_renderer {
    ...
    public function frontpage_available_courses() {
        ...
        $navs = '<div class = "container-fluid">
          <div class = "row">
          <div class="top_wrap col-md-12 text-right mb-2">
            
            <button type="button" id="goToPrevSlide"><i class="fa fa-chevron-right" aria-hidden="true"></i></button>
            <button type="button" id="goToNextSlide"><i class="fa fa-chevron-left" aria-hidden="true"></i></button>
          </div>
          </div>
          </div>';
        return $navs."<div id = 'top-picks'>".$this->coursecat_courses($chelper, $courses, $totalcount)."</div>";
    }
    /**
    ...
    protected function coursecat_coursebox_content(coursecat_helper $chelper, $course) {
        ...
        $data = [
            ...
            'summary' => strip_tags($courseutil->get_summary($chelper), "<br>"),
        ...
        return $this->render_from_template('theme_nebula/nebula_coursecard', $data);
    }
