...
namespace theme_nebula\privacy;
...
class provider implements
    ...
    const FONTTYPE = 'themenebulasettings_fonttype';
    /** The user preference for the enable accessibility toolbar. */
    const TOOLBAR = 'themenebulasettings_enableaccessibilitytoolbar';
    ...
    public static function get_metadata(collection $items) : collection {
        ...
        $items->add_user_preference(self::FONTTYPE, 'privacy:metadata:preference:themenebulasettings_fonttype');
        $items->add_user_preference(self::TOOLBAR, 'privacy:metadata:preference:themenebulasettings_enableaccessibilitytoolbar');
        return $items;
    }
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($toolbar)) {
            writer::export_user_preference(
                ...
                self::TOOLBAR,
                $toolbar,
                get_string('privacy:themenebulasettings_enableaccessibilitytoolbar', 'theme_nebula', $toolbar)
            );
            ...
            if (isset($fontsize)) {
                writer::export_user_preference(
                    ...
                    self::FONTSIZE,
                    $fontsize,
                    get_string('privacy:accessibilitystyles_fontsizeclass', 'theme_nebula', $fontsize)
                );
            }
            ...
            if (isset($sitecolor)) {
                writer::export_user_preference(
                    ...
                    self::SITECOLOR,
                    $sitecolor,
                    get_string('privacy:accessibilitystyles_sitecolorclass', 'theme_nebula', $sitecolor)
                );
            }
        }
        ...
        if (isset($fonttype)) {
            writer::export_user_preference(
                ...
                self::FONTTYPE,
                $fonttype,
                get_string('privacy:themenebulasettings_fonttype', 'theme_nebula', $fonttype)
            );
        }
    }
}
