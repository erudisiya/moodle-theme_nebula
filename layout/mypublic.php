...
$templatecontext = [
    ...
    'headerbuttons' => \theme_nebula\util\extras::get_mypublic_headerbuttons($context, $user),
    'editprofileurl' => \theme_nebula\util\extras::get_mypublic_editprofile_url($user, $courseid),
...
echo $OUTPUT->render_from_template('theme_nebula/mypublic', $templatecontext);
